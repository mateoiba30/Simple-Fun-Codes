...
int adivinar_palabra(char[], int, int, char[], int, char[]);

int main()
{
    char palabra[256], guiones[256], letras_equivocadas[26];
    ...
    getchar();
    vidas=adivinar_palabra(palabra, vidas, longitud, letras_equivocadas, diml_equivocadas, guiones);
...
int adivinar_palabra(char palabra[], int vidas, int longitud, char letras_equivocadas[26], int diml_equivocadas, char guiones[]){
    char letra,letras_dichas[26];
    int aux, letras_acertadas=0, fin=0,diml_dichas=-1;
