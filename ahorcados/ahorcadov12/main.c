...
int main()
{
    ...
    int terminar, dificultad,cant_jugadores,volver=1,longitud, letras_acertadas=0, vidas=6, aux, diml_equivocadas=-1, fin=0, diml_dichas=-1;//diml_equivocadas=-1 no significa ninguna posicion, es para decir que está vacío
...
void titulo(){
    ...
    printf("------------------    (sin acentos, ni mayusculas ni la letra ''enie'') \n");
    printf("|    AHORCADO    | \n");
    printf("------------------ \n");
